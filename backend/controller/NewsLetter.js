...
function sendNews(email, callback) {
  ...
  const newsOptions = {
    ...
    html: `
      ...
      <br />
      <p>Katso tämä video saadaksesi lisätietoa muiden opiskelijoiden kokemuksista: <a href="https://youtu.be/BadnkcGYnzg" target="_blank">Opiskelijoiden kokemuksia</a></p>
      <br />
