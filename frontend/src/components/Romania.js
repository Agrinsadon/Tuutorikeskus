                    ...
                    <>
                        ...
                        <div className="form-container">
                            ...
                            <div className="additional-content">
                                <p>Romaniassa harrastukset maksavat suunnilleen:<br />• Kuntosalijäsenyys, 10€/kk<br />• Elokuvat 4€ <br />• Nyrkkeilykurssi 15-20€/kk <br />• Vapaaottelu kurssi 15-20€/kk<br /> • Ravintolat: Laadusta riippuen 3-15€<br /> • Kahvilat: 2-5€ <br />• Jalkapallo, koripallo, lentopallo, sulkapallo noin 15€/kk<br />
                                <br />Ilmaista harrastettavaa löytyy muun muassa:<br /> • Jalkapallo, koripallo, tennis mm. ulkotiloissa<br /> • Kirjastot <br />• Vaeltelu Romanian luonnon ympäristössä/vuoristoissa.<br /> • Opastetut turistikiertueet kaupungeissa<br /> • Koulun ohjelmat, joissa esimerkiksi jokainen halutessaan pukeutuu kulttuuri vaatetukseen, kulttuuri ruokapäivät tai koulun tanssiaiset.
                                </p>
                            </div>
                            </div>
                            </div> 
